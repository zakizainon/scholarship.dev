<x-app-layout :user=$user>
                                ...
                                <div class="mt-6 ml-3">
                                    <div class="bg-gray-100 p-6 rounded-lg dark:bg-neutral-700">
                                        ...
                                        <ul class="list-disc ml-5 mt-2">
                                            ...
                                            <li>Age not exceeding 35 years on January 1, 2025</li>
                                        </ul>
                                ...
                                <div class="mt-6 ml-3">
                                    <form id="personalForm" name="personalForm" method="POST" action="{{ route('apply.post', ['step' => 'personal']) }}">
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/5">
                                            ...
                                            <input type="text" id="hs-floating-input-emergencyphone" class="phone-format peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                            placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none
                                                            dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600
                                                            focus:pt-6
                                                            focus:pb-2
                                            ...
                                            <label for="hs-floating-input-emergencyphone"
                                                class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                            ...
                                                            peer-[:not(:placeholder-shown)]:translate-x-0.5
                                                            peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                            peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 ">Emergency Phone Number</label>
                                        </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-2 relative w-full md:w-1/2">
                                                    <input type="text" id="hs-floating-input-parentname" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                        ...
                                                        value="{{ (old('parentname') != null) ? old('parentname') : $application->parentname ?? '' }}"
                                                        name="parentname">
                                                ...
                                                <div class="mt-2 relative w-full md:w-1/3">
                                                    <input type="text" id="hs-floating-input-parentrelationship" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                                                        ...
                                                                                        autofill:pt-6
                                                                                        autofill:pb-2" placeholder="03-1234-5678"
                                                        value="{{ (old('parentrelationship') != null) ? old('parentrelationship') : $application->parentrelationship ?? '' }}"
                                                ...
                                                <div class="mt-2 relative w-full md:w-1/3">
                                                    <input type="text" id="hs-floating-input-parentoccupation" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                                                        ...
                                                                                        autofill:pt-6
                                                                                        autofill:pb-2" placeholder="03-1234-5678"
                                                        value="{{ (old('parentoccupation') != null) ? old('parentoccupation') : $application->parentoccupation ?? '' }}"
                                                ...
                                                <div class="mt-2 relative w-full md:w-1/3">
                                                    <input type="text" id="hs-floating-input-parentphone" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                            ...
                                                            value="{{ (old('parentphone') != null) ? old('parentphone') : $application->parentphone ?? '' }}">
                                                ...
                                                <div class="mt-2 relative w-full md:w-1/3">
                                                    <input type="text" id="hs-floating-input-parentaddress" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                                ...
                                                                autofill:pt-6
                                                                autofill:pb-2" placeholder="03-1234-5678"
                                                        value="{{ (old('parentaddress') != null) ? old('parentaddress') : $application->parentaddress ?? '' }}"
                                                        name="parentaddress">
                                                ...
                                                <div class="mt-2 relative w-full md:w-1/3">
                                                    <input type="text" id="hs-floating-input-parentstaffid" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                        ...
                                                        value="{{ (old('parentstaffid') != null) ? old('parentstaffid') : $application->parentstaffid ?? '' }}"
                                                        name="parentstaffid">
                                    ...
                                    <form id="academicForm" name="academicForm" method="POST" action="{{ route('apply.post', ['step' => 'academics']) }}">
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/4">
                                            ...
                                            <select id="hs-floating-input-studylevel" class="peer p-4 pt-6 block w-full border-gray-200 rounded-lg text-sm 
                                                    ...
                                                    name="studylevel">
                                                    <option value="Degree" {{ old('studylevel', $application->studylevel ?? '') == 'Degree' ? 'selected' : '' }}>Bachelor Degree</option>
                                                    <option value="Master" {{ old('studylevel', $application->studylevel ?? '') == 'Master' ? 'selected' : '' }}>Master</option>
                                                    <option value="PHD" {{ old('studylevel', $application->studylevel ?? '') == 'PHD' ? 'selected' : '' }}>PHD</option>
                                            </select>
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/5">
                                            <!-- Commencement Year -->
                                            <input type="text" 
                                                id="hs-floating-input-commencementyear"
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/5">
                                            ...
                                            <input type="text" 
                                                id="hs-floating-input-completionyear"
                                                name="completionyear"
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/3">
                                            ...
                                            <select id="studyextension-select" data-hs-select='{"placeholder": "Any extension taken within your Duration of Study?",
                                                ...
                                                <option value="Yes" {{ old('studyextension') == 'Yes' ? 'selected' : (isset($application->studyextension) ? $application->studyextension == 'Yes' ? 'selected' : '' : '' )}}>Yes</option>
                                                <option value="No" {{ old('studyextension') == 'No' ? 'selected' : (isset($application->studyextension) ? $application->studyextension == 'No' ? 'selected' : '' : '' )}}>No</option>
                                            </select>
                                            <!-- End Select -->
                                        </div>
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/3">
                                            ...
                                            <label for="hs-floating-input-reasonextension"
                                                class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                        ...
                                                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500">
                                                State reason for extension of study </label>
                                        </div>
                        ...
                        <div class="p-3 sm:p-0 ml-5 mr-5 mt-0 mb-5">
                            <div class=" flex flex-col dark:bg-neutral-800 dark:border-neutral-700">
                                <header>
                                    ...
                                    <p class="mt-1 text-sm text-gray-600">
                                        {{ __("Applicant's academic SPM results.") }}
                                    </p>
                                </header>
                                <div class="mt-6 ml-3">
                                <!-- SPM Form -->
                                <form id="spmForm" name="spmForm" method="POST" action="{{ route('apply.post', ['step' => 'spm']) }}" >
                                    @csrf
                                        <div class="mt-2 relative w-full md:w-1/2">
                                            <!--SPM Result-->
                                            <input type="text" id="hs-floating-input-spmresults" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                        placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none
                                                        dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600
                                                        focus:pt-6
                                                        focus:pb-2
                                                        ...
                                                        autofill:pt-6
                                                        autofill:pb-2" placeholder="03-1234-5678"
                                                value="{{ (old('spmresults') != null) ? old('spmresults') : $application->spmresults ?? '' }}"
                                                name="spmresults">
                                            <label for="hs-floating-input-spmresults"
                                                class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                        peer-focus:scale-90
                                                        peer-focus:translate-x-0.5
                                                        peer-focus:-translate-y-1.5
                                        ...
                                        @if($errors->has('spmresults'))
                                        <p class="text-sm text-red-600 ml-2 mt-0" id="hs-validation-name-error-helper">
                                            {{
                                            $errors->first('spmresults') }}</p>
                                        @endif

                                        <div class="mt-2 relative w-full md:w-1/5">
                                            <!--SPM Year-->
                                            <input type="text" id="hs-floating-input-spmyear" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                        placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none
                                                        dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600
                                                        focus:pt-6
                                                        focus:pb-2
                                                        ...
                                                        autofill:pt-6
                                                        autofill:pb-2" placeholder="03-1234-5678"
                                                value="{{ (old('spmyear') != null) ? old('spmyear') : $application->spmyear ?? '' }}"
                                                name="spmyear">
                                            <label for="hs-floating-input-spmyear"
                                                class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                        peer-focus:scale-90
                                                        peer-focus:translate-x-0.5
                                                        peer-focus:-translate-y-1.5
                                                        ...
                                                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                                                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 ">Completion
                                                Year</label>
                                    
                                        </div>
                                        @if($errors->has('spmyear'))
                                        <p class="text-sm text-red-600 ml-2 mt-0" id="hs-validation-name-error-helper">
                                            {{
                                            $errors->first('spmyear') }}</p>
                                        @endif
                                        <!-- Save button -->
                                        <div class="mt-8">
                                            <button type="submit"
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/2">
                                            ...
                                            <label for="hs-floating-input-personalstatement"
                                                class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                        ...
                                                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                                                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 ">Personal Statement</label>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500 ml-3"
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/2">
                                            ...
                                            <label for="hs-floating-input-skillsandextracurricular"
                                                class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                        ...
                                                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                                                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 ">Skills</label>
                                        </div>
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/2">
                                            ...
                                            <label for="hs-floating-input-activityextra"
                                                class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent  origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                        ...
                                                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                                                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 ">Extracurricular Activities</label>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500 ml-3"
                                    ...
                                    <form id="workForm" name="workForm" method="POST" action="{{ route('apply.post', ['step' => 'experience']) }}">
                                        ...
                                        <div class="mt-2 relative w-full md:w-1/5">
                                            ...
                                            <input type="text" id="hs-floating-input-salary" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm 
                                                                                                            ...
                                                                                                            autofill:pt-6
                                                                                                            autofill:pb-2" placeholder=""
                                                value="{{ (old('salary') != null) ? old('salary') : $application->salary ?? '' }}" name="salary">
                                        ...
                                        <p class="mt-2 text-gray-500 dark:text-neutral-400">
                                            <form name="documentForm" method="post" action="/docupload" enctype="multipart/form-data" class="dropzone" id="mykad-form">
                                                ...
                                                <input class="relative m-0 block w-full min-w-0 flex-auto cursor-pointer rounded border border-solid border-secondary-500 bg-transparent 
                                                        ...
                                                        accept="image/png, image/jpeg, image/giy, image/bmp"
                                        ...
                                        <form method="post" action="/docupload" enctype="multipart/form-data" id="passportphoto-form">
                                            ...
                                            <input
                                                class="relative m-0 block w-full min-w-0 flex-auto cursor-pointer rounded border border-solid border-secondary-500 bg-transparent 
                                                        ...
                                                        file:border-inherit file:bg-transparent file:px-3  file:py-[0.32rem] file:text-surface focus:border-primary focus:text-gray-700 
                                                        focus:shadow-inset focus:outline-none dark:border-white/70 dark:text-white  file:dark:text-white"
                                                id="formFileLg" name="uploadfile_passport" type="file" onchange="this.form.submit()" />
                                        ...
                                        @else
                                            <div class="inline-flex ml-3 mt-2">
                                                ...
                                                @if ($document->filetype == 'D02')
                                                    <span class="ml-2 text-blue-600 hover:text-blue-500 decoration-2 hover:decoration-white focus:outline-none opacity-70">{{ $document->filename }}<span>
                                                @endif
                                                @endforeach
                                            </div>
                                        @endif
                                        ...
                                        <form method="post" action="/docupload" enctype="multipart/form-data" class="dropzone" id="transcript-form">
                                            ...
                                            <input
                                                class="relative m-0 block w-full min-w-0 flex-auto cursor-pointer rounded border border-solid border-secondary-500 bg-transparent 
                                                                                            ...
                                                                                            file:border-inherit file:bg-transparent file:px-3  file:py-[0.32rem] file:text-surface focus:border-primary focus:text-gray-700 
                                                                                            focus:shadow-inset focus:outline-none dark:border-white/70 dark:text-white  file:dark:text-white"
                                                id="formFileLg" name="uploadfile_transcript" type="file" accept="application/pdf, application/msword"
                                                onchange="this.form.submit()" />
                                        ...
                                        <form method="post" action="/docupload" enctype="multipart/form-data" class="dropzone" id="offerletter-form">
                                            ...
                                            <input
                                                class="relative m-0 block w-full min-w-0 flex-auto cursor-pointer rounded border border-solid border-secondary-500 bg-transparent 
                                                        ...
                                                        file:border-inherit file:bg-transparent file:px-3  file:py-[0.32rem] file:text-surface focus:border-primary focus:text-gray-700 
                                                        focus:shadow-inset focus:outline-none dark:border-white/70 dark:text-white  file:dark:text-white"
                                                id="formFileLg" name="uploadfile_offerletter" type="file" accept="application/pdf, application/msword"
                                                onchange="this.form.submit()" />
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">DOC, DOCX, PDF (MAX. 2 MB).</p>
                                        </form>
                                        ...
                                        <form method="post" action="/docupload" enctype="multipart/form-data" class="dropzone" id="curriculumvitae-form">
                                            ...
                                            <input
                                                class="relative m-0 block w-full min-w-0 flex-auto cursor-pointer rounded border border-solid border-secondary-500 bg-transparent 
                                                        ...
                                                        file:border-inherit file:bg-transparent file:px-3  file:py-[0.32rem] file:text-surface focus:border-primary focus:text-gray-700 
                                                        focus:shadow-inset focus:outline-none dark:border-white/70 dark:text-white  file:dark:text-white"
                                                id="formFileLg" name="uploadfile_curriculumvitae" type="file" accept="application/pdf, application/msword"
                                                onchange="this.form.submit()" />
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">DOC, DOCX, PDF (MAX. 2 MB).</p>
                                        </form>
                                    ...
                                    <div
                                        ...
                                        <p class="mt-1 text-xs font-medium text-gray-500 dark:text-neutral-500">
                                            ...
                                            <ul>
                                                ...
                                                <li>A copy of confirmation letter</li>
                                            </ul>
                                        </p>
                                        <p class="mt-2 text-gray-500 dark:text-neutral-400">
                                        <form method="post" action="/docupload" enctype="multipart/form-data" class="dropzone" id="employment-form">
                                            ...
                                            <input
                                                class="relative m-0 block w-full min-w-0 flex-auto cursor-pointer rounded border border-solid border-secondary-500 bg-transparent 
                                                                                            ...
                                                                                            file:border-inherit file:bg-transparent file:px-3  file:py-[0.32rem] file:text-surface focus:border-primary focus:text-gray-700 
                                                                                            focus:shadow-inset focus:outline-none dark:border-white/70 dark:text-white  file:dark:text-white"
                                                id="formFileLg" name="uploadfile_employment" type="file" accept="application/pdf, application/msword"
                                                onchange="this.form.submit()" />
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">DOC, DOCX, PDF (MAX. 2 MB).</p>
                                        </form>
    ...
    <script> 
        ...
        document.addEventListener("DOMContentLoaded", function () {
            // Attach event listener only to the mobile phone input field
        ...
        function toggleTextarea() {
            if (studyExtensionSelect.value === "No") {
                reasonExtensionTextarea.disabled = true;
                reasonExtensionTextarea.classList.add("opacity-50", "pointer-events-none");
                reasonExtensionTextarea.value = ""; // Clear the field if disabled
            } else {
                reasonExtensionTextarea.disabled = false;
        ...
        // Salary JavaScript function to format the salary input as RM 2,000.00 without leading zeros
        function formatSalaryInput(input) {
            ...
            parts[0] = parts[0].replace(/^0+/, ''); // This removes leading zeros, if any
            // If the integer part is empty (i.e., the value is just zeros), set it to '0'
            if (parts[0] === '') {
                parts[0] = '0';
            }
            // Add commas for thousands
            parts[0] = parts[0].replace(/\B(?=(\d{3})+(?!\d))/g, ","); 
            // Limit the decimal places to two, if any
            if (parts[1]) {
            ...
            // Add the RM currency symbol at the start
            input.value = 'RM ' + value;
        }
