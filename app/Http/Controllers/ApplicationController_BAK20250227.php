...
class ApplicationController extends Controller
{
    ...
    public function index(Request $request, $step = "personal")
    {
        ...
        // ->join('applications', 'documents.user_id', '=', 'applications.user_id')
        // ->select(
        //     'fileType',
        //     'fileName',
        //     'filePath'
        ...
        $scholarship = DB::table('scholarship_management')
            ...
            if ($scholarship) {
                ...
                Session::put('tab10', $scholarship->parentdetails);
    ...
    public function submission(Request $request){
        ...
        ->select(
            ...
            // DB::raw('TIMESTAMPDIFF(MONTH, applications.startdate, applications.enddate) AS duration'), // Calculate duration in months
        ...
        if ($appStatus == 'draft'){
            ...
            if ($step == "personal"){
                ...
                $validateData = $request->validate([
                    ...
                    'housephone'        => ['required', 'between:9,12'],
                ...
                $application = Application::updateOrCreate(
                    ...
                    [
                        ...
                        'parentstaffid'         => $request->parentstaffid,
                        'tab10'                 => $tab10
                    ]
                );
                ...
                $validateData = $request->validate([
                    ...
                    'reasonextension' => ['nullable', 'max: 200'],
                ]);
                $tab02 = 1;
                ...
                $validateData = $request->validate([
                    'spmresults'        => ['required', 'max: 255'],
                    'spmyear'           => ['required', 'digits: 5'],
                ]);
                $tab03 = 1;
                ...
                $application = Application::updateOrCreate(
                    ['uuid' => $appUuid, 'user_id' => $user_id],
                    [
                        'spmresults'        => $request->spmresults,
                        'spmyear'           => $request->spmyear,
                        'tab03'             => $tab03
                    ]
                );
                // redirect back to sender
                ...
                $validateData = $request->validate([
                    'personalstatement'         => ['required', 'max:2000'],
                    'skillsandextracurricular'  => ['required', 'max:2000'],
                    'activityextra'             => ['required', 'max:2000'],
                ]);
                $tab04 = 1;
